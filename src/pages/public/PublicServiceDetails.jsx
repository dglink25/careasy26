...
const styles = {
  ...
  description: { color: '#64748b', fontSize: '1rem', lineHeight: '1.8', whiteSpace: 'pre-wrap', margin: 0 },
  ...
  lockedContactHint: { padding: '1rem', backgroundColor: '#f1f5f9', borderRadius: '0.75rem', color: '#64748b', fontSize: '0.9rem', textAlign: 'center', marginTop: '0.5rem' },
  ...
  infoBoxTitle: { margin: '0 0 0.25rem 0', fontSize: '1rem', fontWeight: '600', color: '#1e293b' },
  infoBoxText: { margin: 0, fontSize: '0.875rem', color: '#475569' },
  actionsCard: { display: 'flex', gap: '0.75rem' },
  actionButton: { display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', flex: 1, backgroundColor: '#f8fafc', border: '1px solid #e2e8f0', padding: '0.875rem', borderRadius: '0.75rem', color: '#475569', fontWeight: '600', cursor: 'pointer', fontSize: '0.95rem' },
