...
export default function Dashboard() {
  ...
  const StatusBanner = () => {
    ...
    // Entreprise rejetée (et aucune en attente)
  ...
  // ══════════════════════════════════════════════════════════════════════════════
  // DASHBOARD CLIENT (+ bannière si pending/rejected)
  // ══════════════════════════════════════════════════════════════════════════════
  if (!isProvider) {
    return (
        ...
        <div style={s.content}>
          ...
          <div style={s.header}>
            <div style={s.headerMain}>
              ...
              <div style={s.headerActions}>
                <button style={s.headerBtn}><FiBell style={s.headerBtnIcon} /><span style={s.badge}>0</span></button>
          ...
          <div style={s.welcomeCard}>
            <div style={s.welcomeContent}>
              ...
              {/* ✅ Si pending → message d'attente à la place du bouton */}
  ...
  // ══════════════════════════════════════════════════════════════════════════════
  // DASHBOARD PRESTATAIRE (entreprise validée)
  // ══════════════════════════════════════════════════════════════════════════════
  return (
    <div style={s.container}>
      <div style={s.content}>

        {/* Bannière si une autre entreprise est aussi en pending */}
        <StatusBanner />
        ...
        <div style={s.header}>
          <div style={s.headerMain}>
            ...
            <div style={s.headerActions}>
              <button style={s.headerBtn}><FiBell style={s.headerBtnIcon} /><span style={s.badge}>3</span></button>
              <Link to="/settings" style={{ textDecoration: 'none' }}>
                <button style={s.headerBtn}><FiSettings style={s.headerBtnIcon} /></button>
              </Link>
            </div>
...
const s = {
  ...
  bannerDot: {
    width: 10, height: 10, borderRadius: '50%', backgroundColor: '#f59e0b',
  ...
  badge: { position: 'absolute', top: -4, right: -4, backgroundColor: '#ef4444', color: '#fff', fontSize: '0.75rem', fontWeight: 600, width: 18, height: 18, borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' },
  ...
  trend: { display: 'flex', alignItems: 'center', gap: '0.375rem', backgroundColor: '#f0fdf4', color: '#16a34a', padding: '0.375rem 0.75rem', borderRadius: '0.5rem', fontSize: '0.75rem', fontWeight: 600, whiteSpace: 'nowrap' },
