      ...
      <div style={s.content}>
        ...
        <div style={s.tipsSection}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem', flexWrap: 'wrap' }}>
            ...
            <h3 style={{ fontSize: 'clamp(1.125rem, 4vw, 1.25rem)', fontWeight: 700, color: '#1e293b' }}>Conseils pour optimiser votre présence</h3>
          </div>
...
const s = {
  container: { 
    ...
    padding: '2rem 0 4rem',
    '@media (max-width: 768px)': { padding: '1rem 0 3rem' }
  },
  content: { 
    maxWidth: 1400, 
    margin: '0 auto', 
  ...
  headerMain: { 
    ...
    justifyContent: 'space-between', 
    alignItems: 'center',
    '@media (max-width: 640px)': { flexDirection: 'column', gap: '1rem', alignItems: 'flex-start' }
  },
  title: { 
    display: 'flex', 
    alignItems: 'center', 
  ...
  headerBtn: { 
    ...
    cursor: 'pointer', 
    position: 'relative',
    '@media (max-width: 640px)': { width: 40, height: 40 }
  },
  ...
  welcomeCard: { 
    ...
    justifyContent: 'space-between', 
    color: '#fff', 
    boxShadow: '0 10px 30px rgba(239,68,68,.3)',
    '@media (max-width: 768px)': { flexDirection: 'column', textAlign: 'center', gap: '1.5rem' }
  },
  welcomeContent: { 
    flex: 1, 
    paddingRight: '2rem',
    '@media (max-width: 768px)': { paddingRight: 0 }
  },
  welcomeTitle: { 
  ...
  becomeBtn: { 
    ...
    '@media (max-width: 640px)': { width: '100%', justifyContent: 'center' }
  },
  ...
  statCard: { 
    ...
    alignItems: 'center', 
    gap: '1rem',
    '@media (max-width: 480px)': { flexDirection: 'column', textAlign: 'center' }
  },
  statIconWrap: { 
    display: 'flex', 
    alignItems: 'center', 
    ...
    borderRadius: '0.75rem', 
    flexShrink: 0,
    '@media (max-width: 480px)': { width: 48, height: 48 }
  },
  ...
  trend: { 
    ...
    fontWeight: 600, 
    whiteSpace: 'nowrap',
    '@media (max-width: 480px)': { marginTop: '0.5rem' }
  },
  ...
  sectionHeader: { 
    ...
    '@media (max-width: 480px)': { flexDirection: 'column', gap: '0.75rem', alignItems: 'flex-start' }
  },
  sectionTitle: { 
    display: 'flex', 
    alignItems: 'center', 
  ...
  timerCard: { 
    borderRadius: '1rem', 
    padding: 'clamp(1rem, 3vw, 1.5rem)', 
    background: 'linear-gradient(135deg,#e80a0a,#c1201a)', 
    color: '#fff', 
  ...
  timerUnit: { 
    ...
    '@media (max-width: 480px)': { minWidth: '50px' }
  },
  ...
  timerFooter: { 
    ...
    alignItems: 'center', 
    justifyContent: 'space-between',
    '@media (max-width: 480px)': { flexDirection: 'column', gap: '1rem' }
  },
  ...
  timerLink: { color: '#fff', textDecoration: 'none', fontSize: '0.875rem', fontWeight: 600, padding: '0.5rem 1rem', backgroundColor: 'rgba(255,255,255,.2)', borderRadius: '0.5rem', display: 'inline-block' },
  timerInactive: { backgroundColor: '#f1f5f9', borderRadius: '1rem', padding: '1rem', display: 'flex', alignItems: 'center', gap: '0.75rem', color: '#64748b', border: '1px dashed #cbd5e1', flexWrap: 'wrap' },
  timerExpired: { backgroundColor: '#fee2e2', borderRadius: '1rem', padding: '1rem', display: 'flex', alignItems: 'center', gap: '0.75rem', color: '#991b1b', border: '1px solid #fecaca', flexWrap: 'wrap' },
  ...
  modal: { 
    ...
    '@media (max-width: 480px)': { width: '95%' }
  },
