  ...
  return (
    <>
      ...
      <footer style={styles.footer}>
          ...
          <div style={styles.mainGrid} className="footer-grid">
            ...
            <div style={styles.brandCol}>
              ...
              <div style={styles.socialRow}>
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook" style={styles.socialBtn} className="footer-social-btn">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                  </svg>
                </a>
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" style={styles.socialBtn} className="footer-social-btn">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="https://wa.me/2290190078988" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" style={{ ...styles.socialBtn, backgroundColor: '#25D366' }} className="footer-social-btn">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" aria-label="TikTok" style={styles.socialBtn} className="footer-social-btn">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div style={styles.bottomBar}>
          <div style={styles.bottomInner} className="footer-bottom-inner">
            ...
            <div style={styles.bottomLinks}>
              <Link to="/privacy" style={styles.bottomLink}>Politique de confidentialité</Link>
        ...
        <style>{`
          .footer-nav-link:hover { color: #ef4444 !important; padding-left: 4px !important; transition: all 0.2s ease !important; }
          .footer-social-btn:hover { transform: translateY(-3px) scale(1.1) !important; transition: all 0.25s ease !important; }
