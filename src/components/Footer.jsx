...
// ── Remplacez cette URL par votre vrai lien Google Play ───────────────────────
const GOOGLE_PLAY_URL = 'https://play.google.com/store/apps/details?id=com.careasy.app';

// ── Icône SVG Google Play ─────────────────────────────────────────────────────
const GooglePlayIcon = () => (
  <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
    <path d="M3.18 23.76c.36.2.78.24 1.18.1l13.26-7.66-2.88-2.88L3.18 23.76zM.5 1.56C.18 1.96 0 2.5 0 3.12v17.76c0 .62.18 1.16.5 1.56l.08.08 9.94-9.94v-.24L.58 1.48.5 1.56zM20.7 10.26l-2.64-1.52-3.22 3.22 3.22 3.22 2.66-1.54c.76-.44.76-1.14-.02-1.58l-.02.2zM4.36.14L17.62 7.8l-2.88 2.88L1.48.14C1.88-.06 2.3-.04 4.36.14z"/>
  </svg>
);
  ...
  return (
    <footer style={styles.footer}>
      ...
      <div style={styles.mainBody}>
        <div style={styles.mainGrid} className="footer-grid">
          ...
          <div style={styles.brandCol}>
            ...
            {/* ── App Mobile Badge Google Play (RÉEL) ── */}
            ...
            <div style={styles.appBadgesRow}>
              <a
                ...
                aria-label={t('footer.downloadOnGooglePlay')}
              >
                <div style={styles.storeBadgeIcon}>
                  <GooglePlayIcon />
                </div>
                <div style={styles.storeBadgeText}>
                  <span style={styles.storeBadgeSmall}>GET IT ON</span>
      ...
      <style>{`
        ...
        .store-badge:hover { transform: translateY(-3px) !important; box-shadow: 0 8px 20px rgba(0,0,0,0.3) !important; }
