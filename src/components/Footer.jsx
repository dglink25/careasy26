          ...
          <div style={styles.mainGrid} className="footer-grid">
            ...
            <div style={styles.brandCol}>
              ...
              <div style={styles.socialRow}>
                ...
                <a href="https://wa.me/22900000000" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" style={{ ...styles.socialBtn, backgroundColor: '#25D366' }} className="footer-social-btn">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
